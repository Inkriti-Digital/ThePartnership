    ...
    <div class="personal-block">
      ...
      <div class="graphic-row">
        <div class="quote-block"> <span class="headshot"> <img src="img/home-headshot1.png"/> </span>
          <div class="quote">
            <p> <b>Quote from a professional who participated in the program.</b><br/>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. <br/>
              <em>Firstname Last, Position, Company</em> </p>
          </div>
        </div>
        <div class="quote-block"> <span class="headshot"> <img src="img/home-headshot2.png"/> </span>
          <div class="quote">
            <p> <b>Quote from a professional who participated in the program.</b><br/>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. <br/>
              <em>Firstname Last, Position, Company</em> </p>
      ...
      <a href="#" class="section-cta personal-cta"> How we work with professionals </a> </div>
  </div>
    ...
    <div class="alumni-block">
      ...
      <div class="graphic-row">
        <div> <span class="graph-ico">
          ...
          </span> <span class="graph-ico">
          <canvas id="chart-area2" width="180" height="180"/>
          </span> <span class="graph-ico">
          <canvas id="chart-area3" width="180" height="180"/>
          </span> </div>
